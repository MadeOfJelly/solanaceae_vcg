...
std::vector<std::string> level25_semirandom_solofaction_list(void);
std::vector<Card> level25_semirandom_solofaction(const std::string& name);

std::vector<std::string> level25_semirandom_dualfaction_list(void);
std::vector<Card> level25_semirandom_dualfaction(const std::string& name);

std::vector<std::string> levelopen_semirandom_solofaction_list(void);
