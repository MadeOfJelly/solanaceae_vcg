...
std::vector<Card> Cards::assassins(void) {
	return {
		...
		{"Sister Jealousy",5,7,5,{"Revenge: Steal 2 Potion Min 1"},{"- 2 Opp Power Min 1"},"Sister Jealousy cares for her jobs and only takes high value ones. When she is out and about you hope that you have less than her, as her jewelry is just for her and no one should have more than her."},
