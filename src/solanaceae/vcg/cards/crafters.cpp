...
std::vector<Card> Cards::crafters(void) {
	return {
		...
		{"Scrivener",3,6,4,{"Stop Opp Abilitiy"},{"Defeat: Recover 1 of 2 Potion"},"Things need to be written and things need to be copied, which is the Scrivener's job. This puts him into contact with a lot of paper, but also a lot of information."},
		{"Stonemason",4,8,4,{"Stop Opp Abilitiy"},{"Defeat: Recover 1 of 2 Potion"},"The Stonemason is strong and can be found all around town, bur always next to large stones."},
