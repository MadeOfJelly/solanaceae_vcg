...
std::vector<Card> Cards::crafters(void) {
	return {
		...
		{"Glasblower",2,6,2,{"Poison 2 Min 1"},{"Defeat: Recover 1 of 2 Potion"},"Be careful around the Glasblower and don't get distracted by his colorful outfit. Glass hurts both when it is molten and when it is shattered."},
		...
		{"Stonemason",4,8,4,{"Stop Opp Ability"},{"Defeat: Recover 1 of 2 Potion"},"The Stonemason is strong and can be found all around town, but always next to large stones."},
