...
std::vector<Card> Cards::monsters(void) {
	return {
		...
		{"Slicing Mantis",4,6,5,{"Courage: Steal 2 Life Min 1"},{"+ 2 Power"},"A mantis like monster with wings. Extremely dangerous and hungry."},
		...
		{"Poison Lizard",3,6,3,{"Poison 1 Min 0"},{"+ 2 Power"},"A poisonous lizard, which is emitting a disgusting stench."},
		...
		{"Hell Hornet",3,6,4,{"Stop Opp Ability"},{"+ 2 Power"},"A giant red-black hornet with a burning venom in its stinger."},
